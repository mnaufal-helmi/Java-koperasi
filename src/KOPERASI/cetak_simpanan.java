 ...
 * @author user
 */
public class cetak_simpanan extends javax.swing.JFrame {

    /**
     * Creates new form formcetakfaktur
     */
    public cetak_simpanan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Bukti Transaksi Simpanan");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtcari, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
...
String sql="select * from datasimpanan where "+ "noanggota='" +noanggota.getText()
+"'";
 ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
              jTextArea1.setText("                         *** KOPERASI SIMPAN PINJAM ***"+
                      ...
                      "\n"
                                      ...
                                      + "       Tanggal Simpan                           : " + rs.getString(3)+ "\n"
                                      + "       Simp.Pokok                                    : " + rs.getString(4)+ "\n"
                                      + "       Simp.Wajib                                     : " + rs.getString(5) +"\n"
                                      + "       Simp.sukarela                               : " + rs.getString(6) +"\n"
    ...
    private void txtcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcetakActionPerformed
        // TODO add your handling code here:
         try {
          new cetak_simpanan().printComponents(null);
          jTextArea1.print();
          jTextArea1.setText("");
          noanggota.setText("");
...
dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_simpanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new cetak_simpanan().setVisible(true);
            }
        });
    }
