 ...
 * @author user
 */
public class cetak_angsuran extends javax.swing.JFrame {

    /**
     * Creates new form formcetakfaktur
     */
    public cetak_angsuran() {
        initComponents();
...
String sql="select * from dataANGSURAN where "+ "noanggota='" +noanggota.getText()
+"'";
 ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
              jTextArea1.setText("                         *** KOPERASI SIMPAN PINJAM ***"+
                      ...
                      "\n"
                                      ...
                                      + "       Lama Angsuran                            : " + rs.getString(4)+ "\n"
                                      + "       Angsuran                                        : " + rs.getString(5) +"\n"
                                      + "       Tanggal angsur                             : " + rs.getString(6) +"\n"
                                      + "       Total pinjam                                   : " + rs.getString(7) +"\n"
                                      + "       Total Bayar                                     : " + rs.getString(8) +"\n"
                                      + "       sisa                                                 : " + rs.getString(9) +"\n"
                                      +
    ...
    private void txtcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcetakActionPerformed
        // TODO add your handling code here:
         try {
          new cetak_angsuran().printComponents(null);
          jTextArea1.print();
          jTextArea1.setText("");
          noanggota.setText("");
...
dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_angsuran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new cetak_angsuran().setVisible(true);
            }
        });
    }
